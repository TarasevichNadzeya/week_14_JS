...
const myFirstArray = ["Надежда", 35, true]; // объявите переменную здесь
console.log(1, myFirstArray);

//Задание 2
//Создайте массив mySecondArray, заполните его любыми значениями. Выведите длину массива.
const mySecondArray = ["Надежда", "Александр", "Михаил", "Дарья"]; // объявите переменную здесь
...
const myInformation = ["Надежда", 26, "сентября", "весы"];
console.log(3, myInformation.join(' '));
...
console.log(6, countries.shift(0));
...
const squaredNumbers = numbers.map(function (item) { return item * item; });
...
const sumNumbers = (numbers[0] + numbers[numbers.length - 1]);;
console.log(10, sumNumbers);
...
const sortAndPrint = randomNumbers.sort(function (a, b) { return a - b });
